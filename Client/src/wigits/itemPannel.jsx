				...
				{loading ? (
					...
					<div>
						<div className="itemHeader">
							<div className="itemDP">
								<div className="itemDate">
									<h1>Date: </h1>
									<h1 id="purchaseDateInput">{listing.Date}</h1>
								</div>
								<div className="itemPrice">
									<h1>Price: </h1>
									<h1 id="purchasePriceInput">£{listing.Price}</h1>
								</div>
							</div>
						...
						<div className="itemMain">
							<img id="itemLogo" alt="Item Image" />
							<div className="itemInfo">
								<p id="itemName">{listing.Name}</p>
								<p id="itemQuantity">Qunatity: {listing.Quantity}</p>
							</div>
						</div>
					</div>
				)}
